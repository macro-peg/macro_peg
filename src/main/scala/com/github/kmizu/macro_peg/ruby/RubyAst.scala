...
object RubyAst {
  ...
  case class Return(value: Option[Expr], span: Span = UnknownSpan) extends Expr
  ...
  case class MultiAssignExpr(names: List[String], value: Expr, span: Span = UnknownSpan) extends Expr
